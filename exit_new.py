        ...
        if b and c:
            ...
            if free_parking_place < 150:
                ...
                if amount > 10000:
                    ...
                    path = 'a'
                with open("underground_exit_log.txt",path) as f:
                    f.write(log)
                amount +=1
            else:
                free_parking_place = 150
                print ("parking place is empty")
                with open("underground_exit_log.txt",path) as f:
                    f.write(log)
        ...
        if data.empty() != True:
            ...
            while check == 0:
                try:
                    ...
                    with open("underground_exit_log.txt",'a') as f:
